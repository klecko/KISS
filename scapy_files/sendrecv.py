...
found in https://goo.gl/q8dRfT .
That function was out-of-date, so I copied the code I needed and readapted
it to this version if Scapy.
Note: this function probably doesn't work in Windows.
...
# ~ def copied_sniff(count=0, store=1, offline=None, prn = None, lfilter=None, L2socket=None, timeout=None, stopperTimeout=None, stopper = None, *arg, **karg):
    # ~ """The original sniff function was replaced with this one, which allows stopperTimeout and stopper. The original one is commented below this one.
    # ~ Sniff packets
