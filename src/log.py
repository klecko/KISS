...
class verbose(): #verbose class, which will contain an attribute for each module verbose settings.
    ...
    class arps():
        ...
        check_success = reader.getboolean("arps", "check_success")
        check_fail = reader.getboolean("arps", "check_fail")
    ...
    class arps():
        def info(msg_key, **kwargs):
            if log.check_verbose("arps", msg_key):
                ...
                elif msg_key == "check_success":  print("Target", kwargs["target"], "was successfully poisoned.")
        ...
        def warning(msg_key, **kwargs):
            if log.check_verbose("arps", msg_key):
                ...
                elif msg_key == "check_fail":   log.warning("arps", "Target", kwargs["target"], "doesn't seem to be poisoned!")
