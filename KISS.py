...
class Args():
    ...
    def __init__(self, file_loc):
        ...
        try:
            ...
            self.A_CHECK = args.getboolean("arps", "check", fallback="D34D")
...
def main():
    ...
    if args.A_ENABLED:
        arp_spoofer1 = arp.ARP_Spoofer(exit_event, args.A_TARGET_IP, args.A_GATEWAY_IP, args.A_TIME_SECS, args.A_INTERVAL, args.A_DISCONNECT, args.A_CHECK)
        arp_spoofer1.start()
        if args.A_TARGET_IP != "everyone":
            arp_spoofer2 = arp.ARP_Spoofer(exit_event, args.A_GATEWAY_IP, args.A_TARGET_IP, args.A_TIME_SECS, args.A_INTERVAL, args.A_DISCONNECT, args.A_CHECK)
            arp_spoofer2.start()
